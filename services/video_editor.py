...
def crop_and_cut_video(input_path: str, start_time: int, end_time: int, output_filename: str) -> str:
    """Memotong video dan mengubah rasio menjadi 9:16 menggunakan sintaks FFmpeg yang benar."""
    ...
    try:
        (
            ...
            .filter('crop', 'ih*9/16', 'ih') # Crop tengah untuk rasio vertikal TikTok/Reels
